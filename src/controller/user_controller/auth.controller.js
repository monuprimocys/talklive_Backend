...
const { sendEmailOTP, generateOTP, verifyOtp, sendTwilioOTP } = require("../../service/common/otp.service");
        ...
        if (isUser == null) {
            ...
            if (type == "phone") {
                ...
                if (sendOtp) {
                    ...
                    return generalResponse(res, { newUser: true }, "Failed to send OTP", false, true)
                }
            }
            if (type == 'social') {
            ...
            if (type == "phone") {
                ...
                if (sendOtp && updated) {
                    ...
                    return generalResponse(res, { newUser: newUser }, "Failed to send OTP", false, true)
                }
            }
            return generalResponse(
                res,
