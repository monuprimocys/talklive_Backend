...
const { generateQualities, generateQualitiesS3 } = require("../../service/common/videoTranscode.service");
...
async function getPresignedUrl(req, res) {
    try {
        ...
        const result = await getPresignedUploadUrl('reelboost/reels', file_type, mime_type);
